...
describe("[U] ast-extractors/extract-typescript - exotics", () => {
  it("doesn't detects 'exotic' dependencies when no exoticRequireStrings were passed", async () => {
    expect(
  ...
  it("detects dependencies declared with one function names passed as exoticRequireStrings", async () => {
    expect(
      await extractTypescript(
  ...
  it("detects dependencies declared with member expression passed as exoticRequireStrings", async () => {
    expect(
      await extractTypescript(
  ...
  it("detects dependencies declared with multiple function names passed as exoticRequireStrings", async () => {
    expect(
      await extractTypescript(
        "const want = need = require; const yo = want('./required-with-want'); const nope = need('./required-with-need');",
        ["want", "need"]
